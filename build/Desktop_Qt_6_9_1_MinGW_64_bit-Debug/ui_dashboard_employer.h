...
"   "));
        ...
        scrollAreaWidgetContents->setGeometry(QRect(0, 0, 741, 1177));
        ...
        fileUploadLabel = new QLabel(scrollAreaWidgetContents);
        fileUploadLabel->setObjectName("fileUploadLabel");

        postJobForm->setWidget(10, QFormLayout::ItemRole::LabelRole, fileUploadLabel);

        fileUploadButton = new QPushButton(scrollAreaWidgetContents);
        fileUploadButton->setObjectName("fileUploadButton");

        postJobForm->setWidget(10, QFormLayout::ItemRole::FieldRole, fileUploadButton);

        postJobButton = new QPushButton(scrollAreaWidgetContents);
        postJobButton->setObjectName("postJobButton");

        postJobForm->setWidget(11, QFormLayout::ItemRole::FieldRole, postJobButton);
    ...
    void retranslateUi(QDialog *DashboardEmployer)
    {
        ...
        titleLabel->setText(QCoreApplication::translate("DashboardEmployer", "Employer Dashboard - Welcome [User]", nullptr));
        ...
        fileUploadLabel->setText(QCoreApplication::translate("DashboardEmployer", "Upload File (PDF/Description):", nullptr));
        fileUploadButton->setText(QCoreApplication::translate("DashboardEmployer", "Upload File", nullptr));
