...
"       "));
        ...
        if (employerTable->columnCount() < 7)
            employerTable->setColumnCount(7);
        ...
        employerTable->setHorizontalHeaderItem(6, __qtablewidgetitem6);
        ...
        if (jobSeekerTable->columnCount() < 7)
            jobSeekerTable->setColumnCount(7);
        QTableWidgetItem *__qtablewidgetitem7 = new QTableWidgetItem();
        jobSeekerTable->setHorizontalHeaderItem(0, __qtablewidgetitem7);
        QTableWidgetItem *__qtablewidgetitem8 = new QTableWidgetItem();
        jobSeekerTable->setHorizontalHeaderItem(1, __qtablewidgetitem8);
        QTableWidgetItem *__qtablewidgetitem9 = new QTableWidgetItem();
        jobSeekerTable->setHorizontalHeaderItem(2, __qtablewidgetitem9);
        QTableWidgetItem *__qtablewidgetitem10 = new QTableWidgetItem();
        jobSeekerTable->setHorizontalHeaderItem(3, __qtablewidgetitem10);
        QTableWidgetItem *__qtablewidgetitem11 = new QTableWidgetItem();
        jobSeekerTable->setHorizontalHeaderItem(4, __qtablewidgetitem11);
        QTableWidgetItem *__qtablewidgetitem12 = new QTableWidgetItem();
        jobSeekerTable->setHorizontalHeaderItem(5, __qtablewidgetitem12);
        QTableWidgetItem *__qtablewidgetitem13 = new QTableWidgetItem();
        jobSeekerTable->setHorizontalHeaderItem(6, __qtablewidgetitem13);
    ...
    void retranslateUi(QDialog *DashboardAdmin)
    {
        ...
        ___qtablewidgetitem->setText(QCoreApplication::translate("DashboardAdmin", "Employer ID", nullptr));
        ...
        QTableWidgetItem *___qtablewidgetitem6 = employerTable->horizontalHeaderItem(6);
        ___qtablewidgetitem6->setText(QCoreApplication::translate("DashboardAdmin", "Uploaded File", nullptr));
        ...
        QTableWidgetItem *___qtablewidgetitem7 = jobSeekerTable->horizontalHeaderItem(0);
        ___qtablewidgetitem7->setText(QCoreApplication::translate("DashboardAdmin", "Seeker ID", nullptr));
        QTableWidgetItem *___qtablewidgetitem8 = jobSeekerTable->horizontalHeaderItem(1);
        ___qtablewidgetitem8->setText(QCoreApplication::translate("DashboardAdmin", "Full Name", nullptr));
        QTableWidgetItem *___qtablewidgetitem9 = jobSeekerTable->horizontalHeaderItem(2);
        ___qtablewidgetitem9->setText(QCoreApplication::translate("DashboardAdmin", "Location", nullptr));
        QTableWidgetItem *___qtablewidgetitem10 = jobSeekerTable->horizontalHeaderItem(3);
        ___qtablewidgetitem10->setText(QCoreApplication::translate("DashboardAdmin", "Phone", nullptr));
        QTableWidgetItem *___qtablewidgetitem11 = jobSeekerTable->horizontalHeaderItem(4);
        ___qtablewidgetitem11->setText(QCoreApplication::translate("DashboardAdmin", "Blocked", nullptr));
        QTableWidgetItem *___qtablewidgetitem12 = jobSeekerTable->horizontalHeaderItem(5);
        ___qtablewidgetitem12->setText(QCoreApplication::translate("DashboardAdmin", "Action", nullptr));
        QTableWidgetItem *___qtablewidgetitem13 = jobSeekerTable->horizontalHeaderItem(6);
        ___qtablewidgetitem13->setText(QCoreApplication::translate("DashboardAdmin", "Resume", nullptr));
