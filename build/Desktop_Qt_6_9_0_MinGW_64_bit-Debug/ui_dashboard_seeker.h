...
public:
    ...
    void setupUi(QDialog *DashboardSeeker)
    {
        ...
        DashboardSeeker->resize(800, 800);
...
"   "));
        ...
        profileForm->setWidget(6, QFormLayout::ItemRole::FieldRole, updateProfileButton);
        ...
        jobsTable->setMinimumSize(QSize(0, 100));
        jobsTable->setColumnCount(7);
        ...
        applicationsTable->setHorizontalHeaderItem(0, __qtablewidgetitem7);
        QTableWidgetItem *__qtablewidgetitem8 = new QTableWidgetItem();
        applicationsTable->setHorizontalHeaderItem(1, __qtablewidgetitem8);
        QTableWidgetItem *__qtablewidgetitem9 = new QTableWidgetItem();
        applicationsTable->setHorizontalHeaderItem(2, __qtablewidgetitem9);
        QTableWidgetItem *__qtablewidgetitem10 = new QTableWidgetItem();
        applicationsTable->setHorizontalHeaderItem(3, __qtablewidgetitem10);
    ...
    void retranslateUi(QDialog *DashboardSeeker)
    {
        ...
        ___qtablewidgetitem6->setText(QCoreApplication::translate("DashboardSeeker", "Action", nullptr));
        ...
        QTableWidgetItem *___qtablewidgetitem7 = applicationsTable->horizontalHeaderItem(0);
        ___qtablewidgetitem7->setText(QCoreApplication::translate("DashboardSeeker", "Job ID", nullptr));
        QTableWidgetItem *___qtablewidgetitem8 = applicationsTable->horizontalHeaderItem(1);
        ___qtablewidgetitem8->setText(QCoreApplication::translate("DashboardSeeker", "Title", nullptr));
        QTableWidgetItem *___qtablewidgetitem9 = applicationsTable->horizontalHeaderItem(2);
        ___qtablewidgetitem9->setText(QCoreApplication::translate("DashboardSeeker", "Company", nullptr));
        QTableWidgetItem *___qtablewidgetitem10 = applicationsTable->horizontalHeaderItem(3);
        ___qtablewidgetitem10->setText(QCoreApplication::translate("DashboardSeeker", "Status", nullptr));
